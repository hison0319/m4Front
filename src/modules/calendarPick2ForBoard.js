...
//Action type
const SET_CALPICK2_DATE = 'calendarPick2ForBoard/SET_CALPICK2_DATE';
const ADD_CALPICK2_DATE = 'calendarPick2ForBoard/ADD_CALPICK2_DATE';
const SUB_CALPICK2_DATE = 'calendarPick2ForBoard/SUB_CALPICK2_DATE';
...
//Reducer
export default function calendarPick2ForBoard (state = initialState, action) {
    switch(action.type) {
